...
public interface ConnectionsApi {
    ...
    ResponseEntity<Void> connectionPost(@ApiParam(value = "", required = true)  String name, @ApiParam(value = "", required = true)  String address, @ApiParam(value = "", required = false)  String workdir, @ApiParam(value = "",required = false) Integer dockerTLSVerify/*,@RequestParam(value="upfile", required=false)  List<byte[]> upfile @ApiParam(value = "") MultipartFile[] file*/);
    ...
    @RequestMapping(value = "/connections",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Map<String,DockerConnection>> connectionsGet();
    ...
    @ApiOperation(value = "save docker connection to DB", nickname = "connectionsTls", notes = "", tags={ "Connections", })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK"),
            @ApiResponse(code = 201, message = "successfully created") })
    @RequestMapping(value = "/connections/{connection}/tls/",
            consumes = { "multipart/form-data" },
            method = RequestMethod.POST)
    ResponseEntity<Void> connectionsTls(@ApiParam(value = "name of selected connection", required = true) @PathVariable("connection") String connection,@ApiParam(value = "", required=true) @RequestParam(value="name", required=true)  String name,@ApiParam(value = "", required=true) @RequestParam(value="address", required=true)  String address,@ApiParam(value = "", required=true) @RequestParam(value="workdir", required=true)  String workdir,@ApiParam(value = "", required=true) @RequestParam(value="dockerTLSVerify", required=true)  Integer dockerTLSVerify/*,@RequestParam(value="upfile", required=false) @ApiParam(value = "upfile") List<MultipartFile> upfile*/,MultipartRequest request);
